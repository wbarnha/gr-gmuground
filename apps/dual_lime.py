    ...
    def __init__(self, gpredict_port=4532, offset=50e3, parameter_0=0, samp_rate=600e3):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.limesdr_source_0_0 = limesdr.source('0009061C02CF232D', 2, '')
        ...
        self.top_grid_layout.addWidget(self._fosphor_qt_sink_c_0_0_0_win, 0, 2, 7, 4)
        for r in range(0, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 6):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/wbarnhart/test', True)
