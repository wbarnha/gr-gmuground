...
class dual_lime(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, gpredict_port=4532, offset=50e3, samp_rate=2.4e6, wpm=20):
        ...
        self.blocks_selector_0_0 = blocks.selector(gr.sizeof_float*1,0,sat)
        ...
        self.msg_connect((self.satellites_satellite_decoder_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        self.msg_connect((self.satellites_satellite_decoder_0_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        self.msg_connect((self.satellites_satellite_decoder_0_0_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        self.msg_connect((self.satellites_satellite_decoder_0_0_0_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        self.msg_connect((self.satellites_satellite_decoder_0_0_0_0_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        self.msg_connect((self.satellites_satellite_decoder_0_0_0_0_0_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        self.msg_connect((self.satellites_satellite_decoder_0_0_0_0_0_0_0_0, 'out'), (self.show_text_0, 'disp_pdu'))
        ...
        self.connect((self.blocks_selector_0_0, 0), (self.satellites_satellite_decoder_0_0, 0))
        self.connect((self.blocks_selector_0_0, 1), (self.satellites_satellite_decoder_0_0_0, 0))
        self.connect((self.blocks_selector_0_0, 2), (self.satellites_satellite_decoder_0_0_0_0, 0))
        self.connect((self.blocks_selector_0_0, 3), (self.satellites_satellite_decoder_0_0_0_0_0, 0))
        self.connect((self.blocks_selector_0_0, 4), (self.satellites_satellite_decoder_0_0_0_0_0_0, 0))
        self.connect((self.blocks_selector_0_0, 5), (self.satellites_satellite_decoder_0_0_0_0_0_0_0, 0))
        self.connect((self.blocks_selector_0_0, 6), (self.satellites_satellite_decoder_0_0_0_0_0_0_0_0, 0))
    ...
    def set_sat(self, sat):
        self.sat = sat
        self._sat_callback(self.sat)
        self.blocks_selector_0_0.set_output_index(self.sat)
