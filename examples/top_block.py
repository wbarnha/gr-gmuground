...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, adapt=0):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_vector_sink_x_0_1 = blocks.vector_sink_f(1, 1)
        self.blocks_vector_sink_x_0_0 = blocks.vector_sink_f(1, 1)
        self.blocks_vector_sink_x_0 = blocks.vector_sink_f(1, 1)
        ...
        self.blocks_delay_0_0_0_0 = blocks.delay(gr.sizeof_gr_complex*1, int(adapt))
        ...
        self.connect((self.blocks_complex_to_magphase_0, 0), (self.blocks_vector_sink_x_0_0, 0))
        ...
        self.connect((self.blocks_complex_to_real_0_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0, 5))
        ...
        self.connect((self.blocks_delay_0_0_0_0, 0), (self.blocks_complex_to_real_0_0_0_0_0_0, 0))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.blocks_vector_sink_x_0_1, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_complex_to_magphase_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_delay_0_0_0_0, 0))
    ...
    def set_adapt(self, adapt):
        self.adapt = adapt
        self.blocks_delay_0_0_0_0.set_dly(int(self.adapt))
...
def argument_parser():
    ...
    parser.add_argument(
        "--adapt", dest="adapt", type=eng_float, default="0.0",
        help="Set adapt [default=%(default)r]")
    return parser
...
def main(top_block_cls=top_block, options=None):
    ...
    tb = top_block_cls(adapt=options.adapt)
    tb.start()
    tb.show()
